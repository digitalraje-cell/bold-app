...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-primary text-primary-foreground shadow-[var(--shadow-soft)] hover:bg-[var(--primary-hover)] active:scale-[0.98]',
      secondary:
        'border border-foreground/15 bg-surface text-foreground shadow-[var(--shadow-soft)] hover:bg-muted',
